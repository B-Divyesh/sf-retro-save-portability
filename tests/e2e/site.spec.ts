...
test.beforeEach(async ({ page }) => {
  await page.route("https://api.github.com/repos/B-Divyesh/sf-retro-save-portability/releases/latest", route => route.fulfill({
    ...
    body: JSON.stringify({ tag_name: "v0.1.1", html_url: "https://github.com/B-Divyesh/sf-retro-save-portability/releases/tag/v0.1.1", assets: [
      { name: "retro-save-portability_0.1.1_linux-x64.AppImage", browser_download_url: "https://github.com/example/app.AppImage", digest: `sha256:${"a".repeat(64)}` },
      { name: "retro-save-portability_0.1.1_macos-arm64.dmg", browser_download_url: "https://github.com/example/app.dmg", digest: `sha256:${"b".repeat(64)}` },
      { name: "retro-save-portability_0.1.1_windows-x64.msi", browser_download_url: "https://github.com/example/app.msi", digest: `sha256:${"c".repeat(64)}` }
    ] })
  }));
});
